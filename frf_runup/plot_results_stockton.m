...
figure;clf
plot([dat.r2p],out_stockton.r2p,'rs','markerfacecolor','k');hold on
...
title('Stockton Model/Data $R_{2\%}$','interpreter','latex','fontsize',fs)
ylabel('Model','interpreter','latex','fontsize',fs)
xlabel('Data','interpreter','latex','fontsize',fs)
set(gca,'TickLabelInterpreter','latex')
if iprint;print('-dpng','-r300',['./',g.name,'/stockton_mod-dat_r2p.png']);end

figure;clf
plot([in.date],[dat.r2p],'r','linewidth',3);hold all
plot([in.date],[out_stockton.r2p],'ks','markerfacecolor','k','markersize',8)
...
datetick
if iprint;print('-dpng','-r300',['./',g.name,'/stockton_r2p_ts.png']);end
